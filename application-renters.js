...
function initWizardNav() {
  ...
  const indicators = Array.from(document.querySelectorAll("#rentersWizardSteps .auto-wizard-step"));
  ...
  function buildReview() {
    ...
    fillList("reviewProperty", [
      { label: "Rental Address", value: getVal("rental_address") },
      ...
      { label: "Roommates", value: getVal("roommates") },
      { label: "Move-In Date", value: getVal("move_in") }
    ]);

    /* COVERAGE */
    fillList("reviewCoverage", [
      { label: "Personal Property Coverage", value: getVal("property_coverage") },
      ...
      { label: "Item List", value: getVal("item_list") },
