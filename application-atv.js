...
function initWizardNav() {
  const form = document.getElementById("atvAppForm");
  const steps = Array.from(document.querySelectorAll(".form-step"));
  const indicators = Array.from(document.querySelectorAll("#atvWizardSteps .auto-wizard-step"));
  ...
  function buildReview() {
    ...
    // ATV / UTV
    fillList("reviewATV", [
      { label: "Vehicle Type", value: getVal("atv_type") },
      { label: "Year", value: getVal("atv_year") },
      { label: "Make", value: getVal("atv_make") },
      { label: "Model", value: getVal("atv_model") },
      { label: "Engine CC", value: getVal("atv_cc") },
      { label: "Primary Use", value: getVal("atv_use") },
      { label: "VIN", value: getVal("atv_vin") }
    ]);
    ...
    fillList("reviewCoverage", [
      ...
      { label: "Accessories / Upgrades", value: getVal("accessories") },
