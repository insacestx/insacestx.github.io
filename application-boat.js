...
function initWizardNav() {
  const form = document.getElementById("boatAppForm");
  const steps = Array.from(document.querySelectorAll(".form-step"));
  const indicators = Array.from(document.querySelectorAll("#boatWizardSteps .auto-wizard-step"));
  ...
  function buildReview() {
    ...
    // BOAT
    fillList("reviewBoat", [
      { label: "Year", value: getVal("boat_year") },
      { label: "Make", value: getVal("boat_make") },
      { label: "Model", value: getVal("boat_model") },
      { label: "Boat Type", value: getVal("boat_type") },
      { label: "Hull Material", value: getVal("hull_material") },
      { label: "Engine Type", value: getVal("engine_type") },
      { label: "Horsepower", value: getVal("boat_hp") },
      { label: "Hull ID Number", value: getVal("boat_hin") }
    ]);
    ...
    fillList("reviewCoverage", [
      ...
      { label: "Uninsured/Underinsured Boater", value: getVal("um_uim") },
      { label: "Medical Payments", value: getVal("medical_payments") },
      { label: "Additional Equipment", value: getVal("equipment") },
