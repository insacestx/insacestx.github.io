...
function initWizardNav() {
  const form = document.getElementById("motorcycleAppForm");
  const steps = Array.from(document.querySelectorAll(".form-step"));
  const indicators = Array.from(document.querySelectorAll("#motorcycleWizardSteps .auto-wizard-step"));
  ...
  function buildReview() {
    ...
    // MOTORCYCLE
    fillList("reviewMotorcycle", [
      { label: "Year", value: getVal("mc_year") },
      { label: "Make", value: getVal("mc_make") },
      { label: "Model", value: getVal("mc_model") },
      { label: "Engine CC", value: getVal("mc_cc") },
      { label: "Primary Use", value: getVal("mc_use") },
      { label: "Motorcycle License", value: getVal("mc_license") },
      { label: "VIN", value: getVal("mc_vin") }
    ]);
