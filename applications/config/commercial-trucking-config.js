const commercialTruckingConfig = {
  appType: "commercialtrucking",
  ...
  steps: [
    ...
    /* -------------------- VEHICLE & FLEET DETAILS -------------------- */
    {
      ...
      fields: [
        ...
        { id: "unitList", label_en: "List All Power Units (Year/Make/Model/VIN/GVWR)", label_es: "Lista de Unidades (Año/Marca/Modelo/VIN/GVWR)", type: "text" },
        { id: "trailerList", label_en: "List All Trailers (Type/Year/VIN)", label_es: "Lista de Remolques (Tipo/Año/VIN)", type: "text" },
        {
          id: "hiredNonOwned",
    ...
    /* -------------------- DRIVER INFORMATION -------------------- */
    {
      ...
      fields: [
        ...
        { id: "driverList", label_en: "Driver List (Name/DOB/License State/CDL Class/Experience)", label_es: "Lista de Conductores (Nombre/Fecha de Nacimiento/Estado de Licencia/Clase CDL/Experiencia)", type: "text" },
        {
          id: "mvrHistory",
    ...
    /* -------------------- CARGO & OPERATIONS -------------------- */
    {
      ...
      fields: [
        ...
        { id: "hazmatDetails", label_en: "Hazmat Details", label_es: "Detalles de Hazmat", type: "text" },
        {
          id: "oversize",
        ...
        { id: "statesOperated", label_en: "Primary States of Operation", label_es: "Estados Principales de Operación", type: "text" },
        {
          id: "crossState",
    ...
    /* -------------------- COVERAGE OPTIONS -------------------- */
    {
      ...
      fields: [
        ...
        { id: "statedValue", label_en: "Stated Value of Units", label_es: "Valor Declarado de las Unidades", type: "text" },
    ...
    /* -------------------- SAFETY & COMPLIANCE -------------------- */
    {
      ...
      fields: [
        ...
        {
          id: "fmcsarating",
          label_en: "FMCSA Safety Rating",
          label_es: "Calificación de Seguridad FMCSA",
          type: "select",
          options: [
            { value: "", label_en: "Select...", label_es: "Seleccione..." },
            { value: "satisfactory", label_en: "Satisfactory", label_es: "Satisfactoria" },
            { value: "conditional", label_en: "Conditional", label_es: "Condicional" },
            { value: "unsatisfactory", label_en: "Unsatisfactory", label_es: "Insatisfactoria" },
            { value: "notRated", label_en: "Not Rated", label_es: "Sin Calificación" }
          ]
        }
      ]
    }
...
export default commercialTruckingConfig;
